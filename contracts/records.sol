...
contract Records is ERC721 {
    ...
    constructor() ERC721("DVMedicalCoin","DVMC") public {
    ...
    function get_insurance(uint256 patient_id)public view returns (string memory,uint64,string memory,string memory,string memory){
        ...
        insurance memory viewi = insurancelist[patient_id];
        return (viewi.applicable, viewi.policy_no,viewi.insurer,viewi.policy_type,viewi.policy_limit);
    }
    ...
    function get_present_illness(uint256 patient_id)public view returns (string memory,string memory){
        ...
        history memory viewhi = patienthistory[patient_id];
        return (viewhi.complaints,viewhi.duration);
    }
    ...
    function get_past_illness(uint256 patient_id)public view returns (string memory,string memory,string memory){
        ...
        past memory viewpa = pasthistory[patient_id];
        return (viewpa.family_history,viewpa.personal_history,viewpa.drug_history);
    }
    ...
    function get_func_diagnosis(uint256 patient_id)public view returns (string memory,string memory){
        ...
        diag memory viewd = diagnosis[patient_id];
              
        return (viewd.diag_summary,viewd.prescription);    
    ...
    function get_treatment_summary(uint256 patient_id)public view returns (string memory,string memory,uint256,uint256,string memory,string memory){
        ...
        treat memory viewtr = treatment[patient_id];
              
        return (viewtr.treatment,viewtr.date_treatment,viewtr.doctor_id,viewtr.hospital_id,viewtr.discharge,viewtr.follow_up);    
